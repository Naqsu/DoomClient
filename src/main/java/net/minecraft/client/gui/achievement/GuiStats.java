...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    {
        this.buttonList.add(new doom.ui.DoomButton(0, this.width / 2 + 4, this.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new doom.ui.DoomButton(1, this.width / 2 - 160, this.height - 52, 80, 20, I18n.format("stat.generalButton", new Object[0])));
        GuiButton guibutton;

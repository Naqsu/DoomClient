...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void drawWorldBackground(int tint) {
        if (this.mc.theWorld != null) {
            // Jeśli jesteśmy w grze (np. Esc), rysujemy tylko gradient
            this.drawGradientRect(0, 0, this.width, this.height, -1072689136, -804253680);
        } else {
            // Jeśli jesteśmy w MENU (Main, Multi, AltManager) -> Rysujemy nasze cząsteczki!
            // Używamy naszego nowego silnika
            doom.ui.ParticleEngine.render(this.width, this.height, 0, 0);
        }
    }

...
public class GuiConfirmOpenLink extends GuiYesNo
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new doom.ui.DoomButton(0, this.width / 2 - 50 - 105, this.height / 6 + 96, 100, 20, this.confirmButtonText));
        this.buttonList.add(new doom.ui.DoomButton(2, this.width / 2 - 50, this.height / 6 + 96, 100, 20, this.copyLinkButtonText));
        this.buttonList.add(new doom.ui.DoomButton(1, this.width / 2 - 50 + 105, this.height / 6 + 96, 100, 20, this.cancelButtonText));
    }

    ...
    public void drawChat(int updateCounter)
    {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN)
        {
            ...
            if (k > 0)
            {
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                FontManager.r20.drawStringWithShadow(s, (float)i2, (float)(j2 - 8), 16777215 + (l1 << 24));
                ...
                if (flag)
                {
                    int k2 = FontManager.r20.getHeight()
;
    ...
    public IChatComponent getChatComponent(int mouseX, int mouseY)
    {
        ...
        else
        {
            ...
            if (j >= 0 && k >= 0)
            {
                ...
                if (j <= MathHelper.floor_float((float)this.getChatWidth() / this.getChatScale()) && k < FontManager.r20.getHeight()
 * l + l)
                {
                    int i1 = k / FontManager.r20.getHeight()
 + this.scrollPos;
                    ...
                    if (i1 >= 0 && i1 < this.drawnChatLines.size())
                    {
                        ...
                        for (IChatComponent ichatcomponent : chatline.getChatComponent())
                        {
                            ...
                            {
                                j1 += FontManager.r20.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText)ichatcomponent).getChatComponentText_TextValue(), false));

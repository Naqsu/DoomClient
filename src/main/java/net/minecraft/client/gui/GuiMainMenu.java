...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new doom.ui.DoomButton(0, this.width / 2 - 100, j + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new doom.ui.DoomButton(4, this.width / 2 + 2, j + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
    ...
    {
        this.buttonList.add(new doom.ui.DoomButton(1, this.width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new doom.ui.DoomButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));
        ...
        this.buttonList.add(new doom.ui.DoomButton(69, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Alt Manager"));
    }
    ...
    {
        this.buttonList.add(new doom.ui.DoomButton(11, this.width / 2 - 100, p_73972_1_, I18n.format("menu.playdemo", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 69) {
            // Otwieramy nasze GUI i podajemy 'this' jako ekran powrotu
            this.mc.displayGuiScreen(new doom.ui.alt.GuiAltManager(this));
        }
    }

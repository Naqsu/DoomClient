...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new doom.ui.DoomButton(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new doom.ui.DoomButton(5, this.width / 2 + 5, this.height - 52, 150, 20, I18n.format("createWorld.customize.presets", new Object[0])));
        this.buttonList.add(new doom.ui.DoomButton(1, this.width / 2 + 5, this.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));

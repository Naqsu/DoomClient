...
public abstract class GuiSlot
{
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_)
    {
        if (this.field_178041_q)
        {
            ...
            // --- USUNIĘTO RYSOWANIE TŁA (DIRT) ---
            // Tutaj był kod bindujący optionsBackground i rysujący prostokąt.
            // Usunięcie go sprawia, że środek listy jest przezroczysty.
            // -------------------------------------
            ...
            // Opcjonalnie: Zakomentuj te dwie linie, jeśli nie chcesz cienia na górze i dole listy
            ...
            // ... Reszta kodu (Cienie, scrollbar) zostaje bez zmian ...
            int i1 = 4;

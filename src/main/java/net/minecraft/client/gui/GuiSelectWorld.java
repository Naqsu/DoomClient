...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void addWorldSelectionButtons()
    {
        ...
        this.buttonList.add(new doom.ui.DoomButton(3, this.width / 2 + 4, this.height - 52, 150, 20, I18n.format("selectWorld.create", new Object[0])));
        ...
        this.buttonList.add(new doom.ui.DoomButton(0, this.width / 2 + 82, this.height - 28, 72, 20, I18n.format("gui.cancel", new Object[0])));

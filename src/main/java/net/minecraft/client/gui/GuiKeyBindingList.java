...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        public CategoryEntry(String p_i45028_2_)
        {
            ...
            this.labelWidth = FontManager.r20.getStringWidth(this.labelText);

        }

        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
        {
            FontManager.r20.drawString(this.labelText, GuiKeyBindingList.this.mc.currentScreen.width / 2 - this.labelWidth / 2, y + slotHeight - FontManager.r20.getHeight()
 - 1, 16777215);
        }
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
        {
            ...
            FontManager.r20.drawString(this.keyDesc, x + 90 - GuiKeyBindingList.this.maxListLabelWidth, y + slotHeight / 2 - FontManager.r20.getHeight()
 / 2, 16777215);

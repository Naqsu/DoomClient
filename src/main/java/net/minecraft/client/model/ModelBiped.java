...
public class ModelBiped extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (entityIn == net.minecraft.client.Minecraft.getMinecraft().thePlayer && doom.util.RotationUtil.shouldUseCustomPitch) {
            // Używamy pitcha z Killaury (Silent)
            this.bipedHead.rotateAngleX = doom.util.RotationUtil.renderPitch / (180F / (float)Math.PI);
        } else {
            // Używamy normalnego pitcha z gry (Kamera / Inni gracze)
